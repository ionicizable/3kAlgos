package coloringGraph.Classes;

import coloringGraph.validator.EdgeValidator;
import coloringGraph.validator.GraphValidator;
...
public class Graph {
    ...
    private String dVertices = "B A D C G F E";
    private String bVertices = "B A E D C G F";
    ...
    public void edgeColoring(Edge[] graphEdges) {
        ...
        for (int i = 0; i < graphEdges.length; i++){
            System.out.println("Ребро " + graphEdges[i].toString() + " - цвет ---> " + colors[i]);
        }
    }
    ...
    public void coloringByManipulatingRows(int[][] adjacencyMatrix) {
        ...
        for (int i = 0; i < this.vertices.length; i++) {
            System.out.println("Вершина " + this.vertices[i].getName() + " --->  Цвет "
                    + colors[i]);
        }
    ...
    public void greedyColoring(int[][] adjacencyList) {
        ...
        for (int i = 0; i < this.vertices.length; i++) {
            System.out.println("Вершины " + this.vertices[i].getName() + " --->  Цвет "
                    + colors[i]);
        }
    }
